...
Include null model?\footnote{This refers to whether we include the null model of no genetic effect intot he analyses. Note that in the standard Bayesian approach for fine-mapping, this is ignored such that the sum of the posterior probabilities for each variant is 1.} | Input | Output | Function
--- | --- | --- | ---
  - [x] |  p-values | ABF | `approx.bf.p`
- [x] | p-values | Posterior probabilities | `pvals_pp`
- [x] | Marginal z-scores | Posterior Probabilties | `z0_pp`
- [x] | Marginal z-scores | Posterior Probabilties | `z0_pp`
- [ ] | Marginal z-scores | Posterior Probabilties | `ppfunc`
- [ ] | Marginal z-score matrix | Posterior Probabilties | `z0func.mat`
