...
Here, the 90% credible set contains 115 (out of 200) variants, has a claimed coverage of 0.9006 and contains the true causal variant. In the literature, authors would typically report that they have found a 90% credible set containing 115 variants which they are at least 90% confident contains the true causal variant. 
...
In this example, the 90% credible set may in actual fact have nearer to 97.7% coverage of the causal variant in the credible set. 
...
The estimated empirical coverage is found to be approximately 96.9%, so our estimate of ~97.7% is accurate - far more so than the standard 'claimed coverage' of ~90.09%.
