...
The estimated empirical coverage is found to be approximately 97%, so our corrected coverage estimate is accurate - far more so than the standard 'claimed coverage' of ~90%.
