...
The credible set contains 114 (out of 200) variants and the claimed coverage is just over 90%. In papers, we would expect to see authors report that they have found a 90% credible set containing 114 variants, which they are 90% confident contains the true causal variant. 
...
In this example, the 90% credible set may in actual fact have nearer to 98% coverage of the causal variant in the credible set. For the purpose of this vignette and to see the accuracy of this estimate, we simulate more credible sets from the same system and find what proportion of these contains the true causal variant. 
